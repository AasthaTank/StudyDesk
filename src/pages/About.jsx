...
const About = () => {
  return (
    <div className='mt-[100px] text-white w-11/12 max-w-maxContent'>
    {/* Section-1 */}
    <section>
        <div>
            <header>
                ...
                <p>
                StudyDesk is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.
                </p>
            </header>
